...
$site=DB::table('site_settings')->first();
                                		...
                                		<tr>
                                			<td>{{$q->oid}}</td>
                                			<td><a href="{{asset('uploads/')}}/{{$q->preview_url}}" target="_blank"><img src="{{asset('uploads/')}}/{{$q->preview_url}}" width="100 " height="100" style="object-fit: contain;"></a></td>
                                			<td>{{$q->offer_name}}</td>
...
<?php      } ?></td>
  ...
  foreach($device as $d){
                      ...
                      <i class="fadeIn animated bx bx-laptop" title="Mac"></i>
                        ...
                        @endif
<?php }?></td>
                                			<td style="max-width:100px;white-space: normal;"><p>{{$q->countries}}</p></td>
                                		<td>
...
<?php }?></td>
                                    ...
                                    <a  class="btn btn-primary" href="{{url('publisher/offers-details')}}/{{$q->oid}}" target="_blank">Get Details</a>
                                        <?php }
                                        else if($q->approval_status=='Requested'){
                                          ?>
