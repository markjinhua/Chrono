...
<html lang="en">
  <head>
    ...
    <!--favicon-->
        ...
        <link href="{{$site_settings->cdn_url}}site/dashboard_assets/plugins/simplebar/css/simplebar.css" rel="stylesheet" />
    <link href="{{$site_settings->cdn_url}}site/dashboard_assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css" rel="stylesheet" />
    <link href="{{$site_settings->cdn_url}}site/dashboard_assets/plugins/metismenu/css/metisMenu.min.css" rel="stylesheet" />
    <link href="{{$site_settings->cdn_url}}site/dashboard_assets/plugins/smart-wizard/css/smart_wizard_all.min.css" rel="stylesheet" type="text/css" />
    <!-- loader-->
...
By submitting this form, You agree to Our <a href="/privacy/">Privacy Policy</a> and <a href="/terms/">Our Terms and Conditions</a></b>
                                  <br>
...
<div class="col-lg-12 text-center">
    ...
    <script src="{{$site_settings->cdn_url}}site/dashboard_assets/js/popper.min.js"></script>
    <script src="{{$site_settings->cdn_url}}site/dashboard_assets/js/bootstrap.min.js"></script>
    <!--plugins-->

<script src="https://code.jquery.com/jquery-3.5.1.js" integrity="sha256-QWo7LDvxbWT2tbbQ97B53yJnYU3WhH/C8ycbRAkjPDc=" crossorigin="anonymous"></script>
    <script src="{{$site_settings->cdn_url}}site/dashboard_assets/plugins/simplebar/js/simplebar.min.js"></script>
    <script src="{{$site_settings->cdn_url}}site/dashboard_assets/plugins/metismenu/js/metisMenu.min.js"></script>
    <script src="{{$site_settings->cdn_url}}site/dashboard_assets/plugins/perfect-scrollbar/js/perfect-scrollbar.js"></script>
    <script src="{{$site_settings->cdn_url}}site/dashboard_assets/plugins/smart-wizard/js/jquery.smartWizard.min.js"></script><!DOCTYPE html>
<html>
...
$('#account_type_hidden').removeAttr('style','visibility:hidden');
  $('#company_name').attr('style','visibility:hidden');
    ...
    <!-- App JS -->
    <script src="{{$site_settings->cdn_url}}site/assets/js/app.js"></script>
  </body>
</html>
