...
@section('content')
  ...
  <div class="card-body">    		<div class="col-lg-12 text-right mb-4 mt-2">
    				<button class="btn btn-primary"  data-toggle="modal" data-target="#addModal">Add Site Categories</button>
    		</div>
